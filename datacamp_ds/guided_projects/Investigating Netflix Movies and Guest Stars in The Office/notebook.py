...
x = 2011
# lazy so decided to automate the years
...
netflix_movies_col_subset = netflix_movies_col_subset.loc[:, ["title", "country", "genre", "release_year", "duration"]]
...
for x, y in enumerate(netflix_movies_col_subset["genre"]) :
    if y == "Children" :
        colors.append("red")
    elif y == "Documentaries" :
        colors.append("blue")
    elif y == "Stand-Up" :
        colors.append("green")
    else:
